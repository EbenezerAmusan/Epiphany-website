...
import logoImg from "@assets/logo__7ca8a0_1770282868060.png";
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <Link href="/" className="flex items-center gap-2" data-testid="link-home-logo">
            <img
              src={logoImg}
              alt="Epiphany Global"
              className="h-10 md:h-12 w-auto max-w-[50px] object-contain object-left"
            />
            <div className="hidden sm:flex flex-col leading-tight">
              <span className="text-white font-bold text-base tracking-wide">EPIPHANY</span>
              <span className="text-white/80 text-[10px] tracking-[0.2em]">GLOBAL</span>
            </div>
          </Link>
